<section id="serviciu-page">

            <?php if($info == 'Reflexoterapie') { ?>
                <div class="servicii-content-item">
                    <div class="container serviciu-content-header">
                        <div class="serviciu-item-image serv-reflexoterapie">
                            <div class="overlay-serviciu-item-img">
                                <h1 class="overlay-serviciu-item-titlu">
                                    Reflexoterapia
                                </h1>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 servicii-content-item-wrapper">
                                <div class="servicii-content-item-text-wrapper">
                                    <h2 class="servicii-content-item-titlu">
                                        Reflexoterapia
                                    </h2>
                                    <h3 class="servicii-content-item-subtitlu">
                ...
                <?php } else if($info == 'Drenaj') { ?>
                    <div class="servicii-content-item">
                        <div class="container serviciu-content-header"">
                            <div class="serviciu-item-image serv-drenaj-limfatic">
                                <div class="overlay-serviciu-item-img">
                                    <h1 class="overlay-serviciu-item-titlu">
                                        <?php echo $info ?>
                                    </h1>
                ...
                <?php } else if($info == 'Masaj') { ?>
                    <div class="servicii-content-item">
                        <div class="container serviciu-content-header"">
                            <div class="serviciu-item-image serv-masaj">
                                <div class="overlay-serviciu-item-img">
                                    <h1 class="overlay-serviciu-item-titlu">
                                        <?php echo $info ?>
                                    </h1>
                ...
                <?php } else if($info == 'Terapia Bowen') {?>
                    <div class="servicii-content-item">
                        <div class="container serviciu-content-header">
                            <div class="serviciu-item-image serv-terapia-bowen">
                                <div class="overlay-serviciu-item-img">
                                    <h1 class="overlay-serviciu-item-titlu">
                                        <?php echo $info ?>
                                    </h1>
